...
function checkBingoLine(card){
	...
	for(var y = 0 ; y < 7 ; y++){
		...
		card.booleans[y][3] === true && card.booleans[y][4] === true && card.booleans[y][5] === true && card.booleans[y][6] === true){
			line++;
		}
	}
	...
	for(var x = 0 ; x < 7 ; x++){
		...
		card.booleans[3][x] === true && card.booleans[4][x] === true && card.booleans[5][x] === true && card.booleans[6][x] === true){
			line++;
		}
	}
	...
	card.booleans[3][3] === true && card.booleans[4][4] === true && card.booleans[5][5] === true && card.booleans[6][6] === true){
		line++;
	}

	if(card.booleans[6][0] === true && card.booleans[5][1] === true && card.booleans[4][2] === true && 
	card.booleans[3][3] === true && card.booleans[2][4] === true &&	card.booleans[1][5] === true && card.booleans[0][6] === true){
		line++;
	}
...
function createNewBingoCard() {
	...
	cardTitle.onfocus = function(){
		this.setSelectionRange(0, 6);
	}
	cardTitle.onblur = function(){
		window.scrollTo(0,0);
	}

	cardTitle.value = padLeft(cards.length+1, 9);
	...
	cardTitle.focus();
	cardTitle.setSelectionRange(0, 6);
}
...
function strToCard(str){
	...
	for(var index = 0 ; index < values.length ; index+=7){
		card.value.push([values[index], values[index+1], values[index+2], values[index+3], values[index+4], values[index+5], values[index+6]]);
	}
	return card;
}
